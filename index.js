...
let famousQuote = `Qaid-e-Azam said, "Unity, Faith and Discipline."`;
console.log(famousQuote);
// 5. Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
let famous_person = `Qaid-e-Azam Muhammad Ali Jinnah`;
let message = `"Unity, Faith and Discipline."`;
...
let guestList = ["Umair", "Saif", "Irshad"];
...
//  add three guests
let addGuest = ["Saleem", "Nasir", "Sherazi"];
...
let placedToVisit = ["Virgin Islands", "Maldeves", "Nanga Parbat", "Mohin Jo Daro", "Kashmir"];
...
let cities = ["Faisalabad", "Karachi", "Islamabad", "Lahore", "Sahiwal"];
...
// • Test whether an item is in a array
// • Test whether an item is not in a array
let citiesOfPakistan = ["Karachi", "Islamabad", "Faisalabad", "Lahore"];
...
let current_users = ["Athar", "Sherazi", "Ashfaq", "Saeed", "Haider"];
let new_users = ["Khalil", "Sherazi", "Murad", "Saeed", "Salman"];
...
let myFavoritePizza = ["Peri Peri", "Hot Tandoori", "Cheese Lovers"];
